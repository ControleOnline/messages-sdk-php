---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/messages-sdk-php, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/messages-sdk-php`.
...
- Checkout local: `api-community/modules/controleonline/messages-sdk`
